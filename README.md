...
* [`src/woolcat/`](src/woolcat/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/woolcat/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `woolcat` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/woolcat/config.cljs) defaults to `true` in
...
```clj
(ns woolcat.example
  (:require [woolcat.config :as config])
